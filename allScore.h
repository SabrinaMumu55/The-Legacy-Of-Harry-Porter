...
{
	iSetColor(255 , 255 , 255);
	iText(950, 680, "Score: ", GLUT_BITMAP_TIMES_ROMAN_24);

	itoa(score , score_string , 10);
	iText(950, 650, score_string, GLUT_BITMAP_TIMES_ROMAN_24);

	iText(750 , 680 , "Name:", GLUT_BITMAP_TIMES_ROMAN_24);

	iText(750 , 650 , name , GLUT_BITMAP_TIMES_ROMAN_24);
